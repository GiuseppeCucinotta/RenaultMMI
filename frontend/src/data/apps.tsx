...
export const DEFAULT_APPS: AppItem[] = [
  { id: "fuel", name: "Fuel", icon: <img src={tripComputerIcon} alt="" className="w-38" /> },
  ...
  { id: "nav-history", name: "History", icon: <img src={tripHistoryIcon} alt="" className="w-20 h-20" /> },
  { id: "camera", name: "Camera", icon: <ScanEye className="w-20 h-20" /> },
  { id: "parking", name: "Parking", icon: <img src={parkingSensorIcon} alt="" className="w-20 h-20" /> },
